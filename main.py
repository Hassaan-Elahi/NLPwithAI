...
# removing stop words plus puncuations . we can add stop words some time later
def Avg_wordLenght(str):
...
# COUNT SPECIAL CHATACTERS NORMALIZED OVER LENGTH OF CHUNK
...
# ----------------------------------------------------------------------------
# RETURNS NORMALIZED COUNT OF FUNCTIONAL WORDS FROM A Framework for Authorship Identification of
...
# NO OF WORDS THAT OCCURED ONLY ONCE divided by total number of
...
# c(w)  = ceil (log2 (f(w*)/f(w))) f(w*) frequency of most commently used words f(w) frequency of word w
# measure of vocabluray richness and connected to zipfs law, f(w*) const rak kay zips law say rank nikal rahay hein
